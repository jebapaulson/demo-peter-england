      ...
      <div className="flex justify-end sticky z-50 top-0 bg-custom-white">
        <div className="flex justify-between w-11/12 pr-4 ">
          <div className="flex items-center gap-5 pb-1 pt-3">
            ...
            <div>
              <ul className="flex gap-8 font-cabin text-[12px] items-center cursor-pointer px-3">
                <li>
            ...
            <div className="flex gap-8">
              <div className="relative flex items-center border-b border-black overflow-hidden mb-4 font-cabin text-12px">
